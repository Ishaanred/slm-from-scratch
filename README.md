...
- [`docs/phase3/results.md`](docs/phase3/results.md) — Phase 3 results: loss vs tokens, loss vs FLOPs, and train-loss convergence plots across all 3 runs, the data table, and a real training-instability spike found in Run 2's curve (visible directly in the convergence plot).
